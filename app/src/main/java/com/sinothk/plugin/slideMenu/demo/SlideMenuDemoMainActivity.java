...
public class SlideMenuDemoMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        mCbAlpha = findViewById(R.id.menu_cb_alpha);
        mSbAlpha = findViewById(R.id.menu_sb_alpha);
...
//                .init();
        ...
        if (isPic == 0) {
            mMainSwipemenu.setFullColor(SlideMenuDemoMainActivity.this, R.color.colorPrimary);
        } else {
            mCbPic.setChecked(true);
            if (isBlur) {
                mContentRgBlur.check(R.id.content_rb_blur);
                mMainSwipemenu.setBlur(SlideMenuDemoMainActivity.this, R.mipmap.dayu, R.color.colorPrimary, 22f);
            } else if (isChangeBlur) {
                mContentRgBlur.check(R.id.content_rb_changeblur);
                mMainSwipemenu.setChangedBlur(SlideMenuDemoMainActivity.this, R.mipmap.dayu, R.color.colorPrimary);
            } else if (isReverseChangeBlur) {
                mContentRgBlur.check(R.id.content_rb_reversechangeblur);
                mMainSwipemenu.setReverseChangedBlur(SlideMenuDemoMainActivity.this, R.mipmap.dayu, R.color.colorPrimary);
            } else {

                mContentRgBlur.check(-1);
                mMainSwipemenu.setBackImage(SlideMenuDemoMainActivity.this, R.mipmap.dayu, R.color.colorPrimary);
            }
        }
        ...
        mCbPic.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                mEditor.commit();
                Intent intent = new Intent(mContext, SlideMenuDemoMainActivity.class);
...
//            mContentRecyclerView.setAdapter(mTipAdapter);
    ...
    class TipViewHolder extends RecyclerView.ViewHolder {
        ...
        TipViewHolder(View itemView) {
            ...
            mTvContext = itemView.findViewById(R.id.tip_tv_content);
        }
    }
}
